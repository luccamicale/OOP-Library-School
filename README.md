...
**School-Library** is a project where you can add, and consult for books, teachers and students.
...
### Setup
```
- To clone the repository run this command - "https://github.com/luccamicale/OOP-Library-School.git"
- cd school-library
```
